...
public class GUI extends JFrame{
    ...
    public String vicMes = "Nothing yet!";
    public int sec = 0;
    ...
    public GUI() {   //create window 
        this.setTitle("MineSweeper");
        this.setSize(1295, 829);   
        this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);  //close window
        this.setVisible(true); //see window
        this.setResizable(false);  //user cant resize

        for(int i = 0; i < 16; i++) {           //grid
            for(int j = 0; j < 9; j++) {
    ...
    public class Board extends JPanel {
        public void paintComponent(Graphics g) {    //put stuff in window 
            ...
            for(int i = 0; i < 16; i++) {           //grid
                for(int j = 0; j < 9; j++) {
                    ...
                    if(mx >= spacing + i*80 + 6 && mx < spacing + i*80+80-2*spacing + 7 && my >= spacing + j*80 + 80 +  29 && my < spacing + j*80 + 35 + 80 +  80-2*spacing) {
    ...
    public class Click implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if(inBoxX() != -1 && inBoxY() != -1) {
                System.out.println("The mouse is in the [" + inBoxX() + "," + inBoxY() + "], Number of mine neighbors: " + neighbours[inBoxX()][inBoxY()]);
